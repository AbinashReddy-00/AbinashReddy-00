...
- 🕸️ Network Protocol Analysis & Monitoring
- 🔐 Vulnerability Assessment & Penetration Testing

🎓 **Education:** CSE Student (Cybersecurity Specialization)  
...
| **🌐 Networks** | Network Architecture, TCP/IP, Protocol Analysis, Network Monitoring |
| **🤖 AI/ML** | Machine Learning Models, Deep Learning, Anomaly Detection |
| **🧠 RAG Systems** | Information Retrieval, LLMs, Knowledge Bases, Intelligent Q&A |
| **☁️ Cloud** | Cloud Infrastructure, Container Security, DevSecOps |
